...
Attacks in the Cloud</em></font> 
    ...
    <ul>
      <li><a href="../fog1/index.html" accesskey="1" title="">Home</a></li>
      <li id="menu a"><a href="../fog1/user_upload.jsp" accesskey="2" title="">upload</a></li>
      <li><a href="../fog1/view_file.jsp" accesskey="3" title="">Myfiles</a></li>
      <li><a href="../fog1/password_change.jsp"accesskey="4" title="">change password</a></li>
	 
	      <li><a href="../fog1/user_alert.jsp" accesskey="4" title=""> view alert</a></li>
      <li><a href="../fog1/user_login.jsp" accesskey="4" title="">Signout</a></li>
...
<div style="position:absolute; left:25px; top:117px; width: 687px; height: 316px;"> 
	...
	<form name="ff" action="careerinsert7.jsp" ENCTYPE="multipart/form-data" method="post" onsubmit="return validation()">
				
    <tr> 
        <td width="225" height="309"><img src="images/clo.jpeg"/></td>
        <td width="483"><table width="348" height="223" align="center" >
              ...
              <tr> 
                ...
                <td width="219"><font size="2"><font face="Verdana, Arial, Helvetica, sans-serif"><font color="#009933"><%=fn1%></font></font></font></td>
              </tr>
              <tr> 
                <td height="45"><em><fon t color="#663333"><strong><font color="#400040">File 
                  id:</font></strong></font></em></td>
                <td width="219"><font color="#009933"><%=f%></font> </td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td height="32" colspan="2" align="center"><input type="submit" name="submit1" class="button" value="Upload"  /></td>
              </tr>
